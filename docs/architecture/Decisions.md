...
| [0009](decisions/0009-translation-stack.md) | Translation stack | 2026-09-23 | `accepted` | Local LLM (llama.cpp + Qwen2.5-3B) over paragraph chunks, not per-cue; NLLB alt. |
