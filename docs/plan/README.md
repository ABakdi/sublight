...
**Current milestone:** [M03 — Transcription pipeline](milestones/03-Transcription-Pipeline.md) — [M00](milestones/00-Foundations.md), [M01](milestones/01-Player-Core.md) and [M02](milestones/02-Local-ASR-Engine.md) are **done**.
