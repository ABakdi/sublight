...
**Current milestone:** [M04 — Translation pipeline](milestones/04-Translation-Pipeline.md) (blocked on the Qwen license decision, [ADR-0016](../architecture/decisions/0016-model-licensing.md)); [M05 — Extension overlay](milestones/05-Extension-Overlay.md) can start in parallel. M00–M03 are **done**.
