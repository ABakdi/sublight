...
- Reality that delays a milestone goes to [checkpoints](../checkpoints/README.md) with a triage decision — the roadmap only moves *after* a checkpoint says so, never before.